...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .antMatchers(HttpMethod.GET, "/api/image-for-news/**").permitAll()
            ...
            .antMatchers(HttpMethod.GET, "/api/recruitments/**").permitAll()
            .antMatchers(HttpMethod.GET, "/api/_search-all").permitAll()
//            .antMatchers(HttpMethod.GET, "/"+uploadPrefix+"/**").hasAuthority(AuthoritiesConstants.USER)
