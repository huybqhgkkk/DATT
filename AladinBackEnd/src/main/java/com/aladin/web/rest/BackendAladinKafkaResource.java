...
@RestController
@RequestMapping("/api/backend-aladin-kafka")
public class BackendAladinKafkaResource {

    private final Logger log = LoggerFactory.getLogger(BackendAladinKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public BackendAladinKafkaResource(KafkaProperties kafkaProperties) {
