...
import com.aladin.service.CandidateService;
import com.aladin.service.NotificationCandidate;
...
public class CandidateResource {
    ...
    private final NotificationCandidate notificationCandidate;

    private final CandidateRepository candidateRepository;

    public CandidateResource(CandidateService candidateService, NotificationCandidate notificationCandidate, CandidateRepository candidateRepository) {
    ...
    public ResponseEntity<Candidate> createCandidate(@RequestBody Candidate candidate) throws URISyntaxException {
        ...
        notificationCandidate.alertnewStatus(candidate);
