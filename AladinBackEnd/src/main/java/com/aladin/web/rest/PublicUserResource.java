...
public class PublicUserResource {
     ...
     */
    @GetMapping("/users")
    public ResponseEntity<List<UserDTO>> getAllPublicUsers(Principal principal, Pageable pageable) {
        ...
        final Page<UserDTO> page = userService.getAllPublicUsers(user_id,pageable);
