...
import com.aladin.repository.search.EmailtemplateSearchRepository;
...
public class EmailtemplateService {
    ...
    public Emailtemplate save(Emailtemplate emailtemplate) {
        ...
        emailtemplateSearchRepository.save(result);
        return result;
    }
    ...
    public Optional<Emailtemplate> partialUpdate(Emailtemplate emailtemplate) {
        ...
        return emailtemplateRepository
            ...
            .map(savedEmailtemplate -> {
                emailtemplateSearchRepository.save(savedEmailtemplate);
    ...
    public Page<Emailtemplate> search(String query, Pageable pageable) {
        log.debug("Request to search for a page of Emailtemplates for query {}", query);
        return emailtemplateSearchRepository.search(query, pageable);
    }
}
