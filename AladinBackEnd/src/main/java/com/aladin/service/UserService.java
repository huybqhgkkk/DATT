...
public class UserService {
    ...
    public String findEmailLeader (Long employee_id) {
        return userRepository.findEmailLeader(employee_id);
    }
    @Transactional(readOnly = true)
    public String findEmailBoss () {
        return userRepository.findEmailBoss();
    }
    public String findEmailUser (Long employee_id) {
        return userRepository.findEmailUser(employee_id);
    }
    //check department
    @Transactional(readOnly = true)
    public Boolean checkboss (String user_id) {
        if (userRepository.checkboss(user_id) ==1)
        {
            return true;
        }else
        {
    ...
    @Transactional(readOnly = true)
    public Boolean checkmoney (String user_id) {
        if (userRepository.checkmoney(user_id) ==1)
        {
            return true;
        }else
        {
    ...
    @Transactional(readOnly = true)
    public Boolean checkLeader (String user_id) {
        if (userRepository.checkLeader(user_id) ==1)
        {
            return true;
        }else
        {
    ...
    @Transactional(readOnly = true)
    public Page<UserDTO> getAllPublicUsers(String user_id,Pageable pageable) {
        return userRepository.findOneUser(user_id,pageable).map(UserDTO::new);
    }
