    ...
    blurjs: function (options) {
      ...
      function svg(amt) {
        ...
        $('body').append(
          '<svg id="blurjs-' +
            ...
            '"><filter id="blur' +
            amt +
            'px"><feGaussianBlur in="SourceGraphic" stdDeviation="' +
            amt +
      ...
      function css(cssClass, amt) {
        ...
        return (
          ...
          'px);filter: url("#blur' +
          amt +
          'px");filter:progid:DXImageTransform.Microsoft.Blur(pixelradius=' +
          amt +
          ');}.' +
          cssClass +
          ' img{filter:progid:DXImageTransform.Microsoft.Blur(pixelradius=' +
          amt +
          ');}</style>'
        );
      }
