    ...
    return (
      ...
      p
        ? Object.assign(
            ...
            (m[h] = d ? '0' : ''),
            (m.transform =
              2 > (g.devicePixelRatio || 1) ? 'translate(' + e + 'px, ' + u + 'px)' : 'translate3d(' + e + 'px, ' + u + 'px, 0)'),
            m)
          )
        ...
        (o = void 0 === o || o),
          ...
          null != t.modifiersData.popperOffsets &&
            (t.styles.popper = Object.assign(
              ...
              t.styles.popper,
              T(
                Object.assign({}, e, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: o, roundOffsets: n })
              )
            )),
    ...
    oe = {
      ...
      fn: function (e) {
        ...
        if (((e = L(s)), (s = 0 <= ['left', 'right'].indexOf(s) ? 'height' : 'width'), i && a)) {
          r = M(
            'number' != typeof (r = 'function' == typeof (r = r.padding) ? r(Object.assign({}, n.rects, { placement: n.placement })) : r)
              ? r
              : k(r, C)
          );
          var f = d(i),
