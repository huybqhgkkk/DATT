...
export class ApplicationConfigService {
  ...
  // getEndpointFor2(api: string, microservice?: string): string {
  //   if(microservice) {
  //     console.log("testapi:", api, " ;endpointPrefix:", this.endpointPrefix.toString());
  //   }
  //     const endpoint = `${this.endpointPrefix}services/aladintechcobackendtest/${api}`;
  //     console.log("micro endpoint:",endpoint);
  //     return endpoint;
  //
  //
