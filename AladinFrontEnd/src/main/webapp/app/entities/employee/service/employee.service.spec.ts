...
describe('Service Tests', () => {
  describe('Employee Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        id: 0,
        first_day_work: currentDate,
        full_name: 'AAAAAAA',
        phone_number: 'AAAAAAA',
        email: 'AAAAAAA',
        date_of_birth: currentDate,
        countryside: 'AAAAAAA',
        current_residence: 'AAAAAAA',
        relative: 'AAAAAAA',
        favourite: 'AAAAAAA',
        education: 'AAAAAAA',
        experience: 'AAAAAAA',
        english: 'AAAAAAA',
        objective_in_cv: 'AAAAAAA',
        marital_status: 'AAAAAAA',
        children: 'AAAAAAA',
        family: 'AAAAAAA',
      };
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            first_day_work: currentDate.format(DATE_FORMAT),
        ...
        const returnedFromService = Object.assign(
          {
            ...
            date_of_birth: currentDate.format(DATE_FORMAT),
            countryside: 'BBBBBB',
            current_residence: 'BBBBBB',
            relative: 'BBBBBB',
            favourite: 'BBBBBB',
            education: 'BBBBBB',
            experience: 'BBBBBB',
            english: 'BBBBBB',
            objective_in_cv: 'BBBBBB',
            marital_status: 'BBBBBB',
            children: 'BBBBBB',
            family: 'BBBBBB',
          },
          elemDefault
      ...
      describe('addEmployeeToCollectionIfMissing', () => {
        ...
        it('should add only unique Employee to an array', () => {
          const employeeArray: IEmployee[] = [{ id: 123 }, { id: 456 }, { id: 58824 }];
