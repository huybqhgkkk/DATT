...
import { FileExtensionValidator } from '../../../custom-validation/inputFileValidation';
...
export class EmployeeCreateComponent implements OnInit {
  ...
  editForm = this.fb.group(
    ...
    {
      validator: [FileExtensionValidator('avatar',['jpg','png'])],
    }
  );
  scale = 1;
  showCropper = false;
  ...
  protected createForm(employee: IEmployee): void {
    this.editForm.patchValue({
      id: employee.id,
      ...
      user: this.usersSharedCollection[0].login,
      department: this.departmentsSharedCollection[0].departmentName,
    });
