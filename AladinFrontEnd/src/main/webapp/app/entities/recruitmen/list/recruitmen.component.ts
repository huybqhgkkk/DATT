...
@Component({
  selector: 'jhi-recruitmen',
  templateUrl: './recruitmen.component.html',
  styleUrls: ['../detail/recruitment.component.scss'],
})
export class RecruitmenComponent implements OnInit {
  ...
  constructor(
    protected recruitmenService: RecruitmenService,
  ...
  delete(recruitmen: IRecruitmen): void {
    const modalRef = this.modalService.open(RecruitmenDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.recruitmen = recruitmen;
