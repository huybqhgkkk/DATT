...
export class EmailtemplateComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.emailtemplateService
      ...
      .subscribe(
        (res: HttpResponse<IEmailtemplate[]>) => {
  ...
  trackId(index: number, item: IEmailtemplate): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IEmailtemplate[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
