...
/**
 * Criteria class for the {@link com.aladin.domain.Heroes2} entity. This class is used
 * in {@link com.aladin.web.rest.Heroes2Resource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /heroes-2-s?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class Heroes2Criteria implements Serializable, Criteria {
    ...
    public Heroes2Criteria() {}

    public Heroes2Criteria(Heroes2Criteria other) {
    ...
    @Override
    public Heroes2Criteria copy() {
        return new Heroes2Criteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final Heroes2Criteria that = (Heroes2Criteria) o;
        return (
