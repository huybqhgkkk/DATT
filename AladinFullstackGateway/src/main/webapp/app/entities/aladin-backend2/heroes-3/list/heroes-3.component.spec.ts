...
import { Heroes3Component } from './heroes-3.component';

describe('Component Tests', () => {
  describe('Heroes3 Management Component', () => {
    let comp: Heroes3Component;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(Heroes3Component, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.heroes3s?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
