...
import { Heroes2Component } from './heroes-2.component';

describe('Component Tests', () => {
  describe('Heroes2 Management Component', () => {
    let comp: Heroes2Component;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(Heroes2Component, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.heroes2s?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
